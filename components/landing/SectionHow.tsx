  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      details: [
        ...
        'Visible and demonstrable via HHF-AI MRI technology',
      ],
    ...
    },
    {
      ...
      details: [
        ...
        'Register on Base Mainnet via hydrogen spin MRI-based PoC protocol',
        'Permanent proof of contribution—liberated from gatekeeping',
        'Visible and demonstrable to all on the blockchain',
