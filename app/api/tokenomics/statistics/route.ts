...
import { tokenomicsTable, epochBalancesTable, epochMetalBalancesTable, allocationsTable } from '@/utils/db/schema'
    ...
    try {
        ...
        if (!process.env.DATABASE_URL) {
            ...
            return NextResponse.json({
                ...
                total_supply_by_metal: { gold: 45000000000000, silver: 22500000000000, copper: 22500000000000 },
                total_distributed_by_metal: { gold: 0, silver: 0, copper: 0 },
                total_remaining_by_metal: { gold: 45000000000000, silver: 22500000000000, copper: 22500000000000 },
                epoch_balances: {},
        ...
        const totalSupply = totalSupplyByMetal.gold + totalSupplyByMetal.silver + totalSupplyByMetal.copper
        const totalDistributed = totalDistributedByMetal.gold + totalDistributedByMetal.silver + totalDistributedByMetal.copper
